-- ==============================================================================
-- MAZAL POS & ERP - ESQUEMA OFICIAL SUPABASE POSTGRESQL & REALTIME
-- ==============================================================================
-- Ubicación: scripts/sql/supabase_schema.sql
-- Instrucciones:
-- 1. Ve a https://supabase.com/dashboard/project/_/sql/new
-- 2. Pega este contenido y presiona "Run" para crear todas las tablas limpias.
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS public.products (
    ...
    sku TEXT,
    name TEXT NOT NULL,
    brand TEXT DEFAULT 'MAZAL',
    category TEXT DEFAULT 'Abarrotes Generales',
    subcategory TEXT DEFAULT 'entero',
...
-- 7. TABLA DE SESIONES DE CAJA Y TURNOS
...
-- 10. TABLA DE USUARIOS DEL SISTEMA (CON CREDENCIALES DE ADMINISTRADOR)
...
-- 14. TABLAS DE FINANZAS Y LOGÍSTICA
...
-- 15. AUDITORÍA Y ESTADO DE LA APLICACIÓN
...
-- 16. INSERCIÓN DE USUARIO ADMINISTRADOR BASE (La contraseña se inicializa con: npm run seed:admin)
INSERT INTO public.users (id, username, name, password, role, status)
VALUES ('USR_ADMIN', 'admin', 'Administrador General', '', 'Administrador', 'Activo')
...
VALUES
    ('SUC_NORTE', 'Norte', 'SUC-01', 'Blvd. Industrial #450, Norte', 'Administrador', 'Activo', true),
    ('SUC_SUR', 'Sur', 'SUC-02', 'Calz. de las Luces #78, Sur', 'Administrador', 'Activo', false),
    ('SUC_CENTRO', 'Centro', 'SUC-03', 'Av. Juárez #100, Centro', 'Administrador', 'Activo', false),
    ('SUC_BODEGA', 'Bodega', 'SUC-04', 'Parque Logístico Nave 12', 'Administrador', 'Activo', false)
ON CONFLICT (id) DO NOTHING;

-- 17. POLÍTICAS ROW LEVEL SECURITY (RLS)
